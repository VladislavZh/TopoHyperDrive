...
class CIFAR100Datamodule(LightningDataModule):
    ...
    def setup(self, stage: str | None = None) -> None:
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            train_data = CIFAR100(root=self.hparams.data_dir, train=True, transform=self.transforms['train'])
            val_test_data = CIFAR100(root=self.hparams.data_dir, train=False, transform=self.transforms['test'])
            ...
            self.data_train, self.data_val, self.data_test = train_data, val_data, test_data
